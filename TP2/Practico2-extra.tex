...
\begin{enumerate}
  ...
  \item Escribir un programa que instale un handler para \texttt{SIGINT}, cuente cuántas veces recibió la señal y termine limpiamente con un EOF (\texttt{Ctrl+D}) por \texttt{STDIN}.
\end{enumerate}
